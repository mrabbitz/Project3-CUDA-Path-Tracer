...
|*Left: Light Ray * ***directly*** *illuminating the floor from the viewer's perspective*|
|*Right: Light Ray * ***indirectly*** *illuminating the floor from the viewer's perspective via one or more intermediate bounces*|
